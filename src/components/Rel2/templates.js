...
//  console.log(props.data.addArrayInput);
    ...
    let quant2 = [];
      ...
      quant2.push(
          ...
          <View style={styles.containerItem} key={1}>

          <Text style={styles.itemTitle}>QUANT:</Text> 
          <Text style={styles.itemTitle}>{props.data.addArrayInput.quant2}</Text>

          <Text style={styles.itemTitle}>PROGRAM:</Text> 
          <Text style={styles.itemTitle}>{props.data.addArrayInput.program2}</Text>
    ...
    let quant3 = [];
      ...
      quant3.push(
          ...
          <Text style={styles.itemTitle}>QUANT:</Text> 
          <Text style={styles.itemTitle}>{props.data.addArrayInput.quant1}</Text>

          <Text style={styles.itemTitle}>PROGRAM:</Text> 
          <Text style={styles.itemTitle}>{props.data.addArrayInput.program1}</Text>
