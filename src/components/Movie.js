...
//                       </Text>
//                       <Text style={styles.vote_average}>
//                         Average Votes: "sadasdasdASCSDVSdds"
//                       </Text>
//                       <Text style={styles.vote_average}>
//                         Release Date:{" "}
...
//         <View style={styles.movieDetails}>
//             <Text style={styles.movieTitle}>{props.data.nome}</Text>                    
//         </View>
...
// export function PdfDocumenttt(props) {
// console.log("pdf props", props.data);
//   return (
//     <Document>
//       <Page style={styles.page}>
...
//           ? props.data.map((a, index) => {
//               return (
//                   <View key={index}  style={styles.movieDetails}>
//                    <Text style={styles.movieTitle}>{a.title}</Text>
